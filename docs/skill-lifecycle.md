...
> **强制 10 步链路**：本仓库 Skill 治理与任何非例行 commit 受 `.claude/hooks/check-9step.sh` 拦截。完整流程见 [`docs/standards/AGENT_ORG_INDEX.md`](AGENT_ORG_INDEX.md) + 模板 [`docs/tasks/_template.md`](../tasks/_template.md)。
